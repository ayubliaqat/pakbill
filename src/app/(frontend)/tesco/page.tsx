// src/app/(frontend)/tesco/page.tsx
...
const disco = getDiscoByCode('tesco')!
...
export default function TescoPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-4xl space-y-10">
          ...
          <div>
            ...
            <p className="mt-3 leading-7 text-body">
              ...
              meters serving one building. Before paying, match the meter number on your bill
              against your actual meter. If you&apos;ve just moved in, check three things: whether
              your meter is genuinely separate, whether a previous balance is already sitting on the
              account, and whether the tariff is residential or commercial.
            </p>
          </div>
          <div>
            <h2 className="text-xl font-bold text-heading sm:text-2xl">
            ...
            <p className="mt-3 leading-7 text-body">
              ...
              has shifted between protected and unprotected residential status. Look past the total
              amount due. Check the tariff code, units consumed, previous balance, fuel price
              adjustment, and taxes individually.
            </p>
          </div>
          <div>
