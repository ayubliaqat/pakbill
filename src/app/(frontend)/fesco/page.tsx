...
const steps = [
  {
    ...
    text: 'Locate the 14-digit reference number on the top-left of any previous FESCO bill, just below your consumer name.',
  },
  {
  ...
  },
  {
    ...
    text: 'Use the button above to open the official PITC FESCO bill page in a new tab, showing your full duplicate bill.',
  },
]
...
export default function FescoPage() {
  return (
    <>
      <script
