// src/app/(frontend)/lesco/page.tsx
...
const disco = getDiscoByCode('lesco')!
...
const steps = [
  {
    ...
    text: 'Locate the 14-digit reference number on the top-left of any previous LESCO bill, just below your consumer name.',
  },
  {
  ...
  },
  {
    ...
    text: 'Use the button above to open the official PITC LESCO bill page in a new tab, showing your full duplicate bill.',
  },
]
...
export default function LescoPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-4xl space-y-10">
          ...
          <div>
            ...
            <p className="mt-3 leading-7 text-body">
              ...
              {disco.name}&apos;s own website rather than an old contact list, since these details
              change over time. For wrong readings, photograph your meter the same day you file a
              complaint. For payment issues, hold onto your bank, wallet, or franchise receipt until
              the official bill reflects your payment. A recorded complaint number is always more
              useful than repeated calls with nothing on file.
            </p>
          </div>
        </div>
      </section>

      {/* How to check — genuinely sequential, numbering is warranted */}
      ...
      {/* FAQ — real accordion, matching Home page pattern */}
