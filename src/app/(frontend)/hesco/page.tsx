// src/app/(frontend)/hesco/page.tsx
...
const disco = getDiscoByCode('hesco')!
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `/${disco.code}` },
  openGraph: {
    title: `${disco.name} Bill Check Online — ${disco.fullName}`,
...
const faqs = [
  {
    ...
    a: 'Your 14-digit reference number is printed in the top-left section of any previous physical bill, just below your consumer name.',
  },
  {
    q: 'Can I use my Customer ID instead of the reference number?',
    a: "Yes. If you don't have your reference number handy, you can enter your Customer ID instead.",
  },
  {
    q: `Is this an official ${disco.name} or PITC website?`,
    a: 'No. PakBill is an independent helper tool. Your number is sent directly to the official PITC bill portal.',
  },
  {
    q: 'Why does my bill show a previous balance?',
    a: `A carried-forward balance is common. Check with your landlord or the previous account holder.`,
  },
  {
    q: "What do I do if the bill doesn't load?",
    a: "Double-check that you entered all digits with no spaces. If it still fails, it's usually temporary PITC server maintenance.",
  },
]
...
const serviceSchema = {
  ...
  provider: { '@type': 'Organization', name: 'PakBill', url: SITE_URL },
  areaServed: disco.region,
  name: `${disco.name} Bill Check`,
  description: `Free online duplicate bill checker for ${disco.fullName} consumers.`,
}

export default function HescoPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center text-center">
          <div className="mx-auto flex w-full max-w-2xl flex-col items-center">
            ...
            <p className="mt-4 max-w-md text-xs text-muted">
              Independent helper page. Your bill opens on the official PITC website.
            </p>
            <Link
              href="/calculator"
        ...
        <div className="mx-auto max-w-4xl space-y-10">
          <div>
            <h2 className="text-xl font-bold text-heading sm:text-2xl">
              {disco.name} Bill Check for {disco.region.split(',')[0]}
            </h2>
            <p className="mt-3 leading-7 text-body">
              {disco.name} serves {disco.region}. This page pulls your official {disco.name} bill
          ...
          <div>
            ...
            <p className="mt-3 leading-7 text-body">
              Ensure you match the meter number on your bill against your actual meter, especially
          ...
          <div>
            ...
            <p className="mt-3 leading-7 text-body">
              Always check {disco.name}'s own website for current helpline numbers and office
              locations.
            </p>
          </div>
        </div>
